...
sed -i 's/  advertiseAddress: 1.2.3.4/  advertiseAddress: 192.168.1.10/' ClusterConfiguration.yaml
...
#Set the kubernetesVersion to the version you installed in install.sh
sed -i 's/kubernetesVersion: .*/kubernetesVersion: 1.22.4/' ClusterConfiguration.yaml
